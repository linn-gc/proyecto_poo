...
public class frmLogin extends javax.swing.JFrame {
     ...
     */
    public frmLogin(SistemaVentas sistema) {
    ...
    private void configuracionAdicional() {
        ...
        // Hacer que el botón "Cancelar" cierre la aplicación
    ...
    private void initComponents() {
        ...
        jPanel1.setName("panelTitulo"); // NOI18N
        jPanel1.setPreferredSize(new java.awt.Dimension(414, 80));

        jLabel1.setFont(new java.awt.Font("Arial", 1, 20)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("SISTEMA DE CONCESIONARIA");
    ...
    private void autenticar() {
        ...
        // Obtener la contraseña del campo de texto (debe ser JPasswordField)
        char[] pwd;
        if (jTextField2 instanceof JPasswordField) {
            pwd = ((JPasswordField) jTextField2).getPassword();
        } else {
            pwd = jTextField2.getText().toCharArray();
        }
        String clave = new String(pwd);
        Arrays.fill(pwd, '\0'); // clear sensitive data
        ...
        Empleado empleado = sistema.autenticar(usuario, clave);
        ...
        if (empleado != null) {
            ...
            if (empleado instanceof Administrador) {
                new MenuAdministradorFrame(sistema, (Administrador) empleado).setVisible(true);
            } else if (empleado instanceof Vendedor) {
                new MenuVendedorFrame(sistema, (Vendedor) empleado).setVisible(true);
            }
        } else {
            JOptionPane.showMessageDialog(this,
